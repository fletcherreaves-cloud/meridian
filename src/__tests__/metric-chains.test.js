...
const EMITS = {
  ...
  auditRows: ['at', 'avgCheck', 'cashOSDollar', 'cashOSPct', 'date', 'detail', 'drawerGC', 'drawerOpens', 'drawerSales', 'emp', 'empMealCh', 'empMealDisc', 'empToken', 'gteCol', 'gteVal', 'label', 'loc', 'manualRefAmt', 'manualRefCnt', 'mgrMealAmt', 'mgrMealCnt', 'orderCol', 'posOverAmt', 'posOverCnt', 'promoAmt', 'promoCnt', 'promoPct', 'refundCash', 'refundCashless', 'refundCnt', 'registerType', 'select', 'tRedAAvg', 'tRedACnt', 'tRedADollar', 'tRedAPct', 'tRedBAvg', 'tRedBCnt', 'tRedBDollar', 'tRedBPct', 'table'],
  ...
  opsCashRows: ['cashOSAmt', 'cashOSPct', 'cashRefAmt', 'cashRefCnt', 'cashlessRefAmt', 'cashlessRefCnt', 'date', 'discAmt', 'discCnt', 'discPct', 'drawerOpens', 'dt', 'loc', 'mealDiscAmt', 'metrics', 'netSalesAmt', 'posOverAmt', 'posOverCnt', 'promoAmt', 'promoCnt', 'promoPct', 'tRedAAmt', 'tRedACnt', 'tRedAPct', 'tRedBAmt', 'tRedBCnt', 'tRedBPct', 'tenant_id', 'timeSlice', 'updated_at'],
  opsLaborRows: ['crewHrs', 'date', 'dt', 'laborDollar', 'loc', 'metrics', 'needed', 'otDollar', 'otHrs', 'tenant_id', 'timeSlice', 'updated_at'],
