...
const EMITS = {
  ...
  opsCashRows: ['cashOSAmt', 'cashOSPct', 'cashRefAmt', 'cashRefCnt', 'cashlessRefAmt', 'cashlessRefCnt', 'date', 'discAmt', 'discPct', 'drawerOpens', 'dt', 'loc', 'mealDiscAmt', 'metrics', 'netSalesAmt', 'posOverAmt', 'posOverCnt', 'promoAmt', 'promoPct', 'tRedAAmt', 'tRedACnt', 'tRedAPct', 'tRedBAmt', 'tRedBCnt', 'tRedBPct', 'tenant_id', 'timeSlice', 'updated_at'],
