...
const EMITS = {
  ...
  opsCashRows: ['cashOSAmt', 'cashOSPct', 'cashRefAmt', 'cashRefCnt', 'cashlessRefAmt', 'cashlessRefCnt', 'date', 'discAmt', 'discPct', 'drawerOpens', 'loc', 'mealDiscAmt', 'netSalesAmt', 'tRedAAmt', 'tRedACnt', 'tRedAPct', 'tRedBAmt', 'tRedBCnt', 'tRedBPct', 'timeSlice'],
  opsLaborRows: ['date', 'laborDollar', 'loc', 'otDollar', 'otHrs', 'timeSlice'],
