...
const EVENT_TYPES={
  ...
  tornado:      {label:'Tornado',              icon:'🌪',  col:'var(--crit)'},
  ...
  hurricane:    {label:'Hurricane',            icon:'🌀',  col:'var(--crit)'},
  ...
  comp:         {label:'Competition (General)', icon:'🏪',  col:'var(--crit)'},
  comp_new:     {label:'Competitor — New Opening',   icon:'🆕',  col:'#fb923c'},
  comp_promo:   {label:'Competitor — Promo/Deal',    icon:'💸',  col:'var(--crit)'},
