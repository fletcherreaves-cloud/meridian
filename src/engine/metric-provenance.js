...
export const METRIC_PROVENANCE = {
  ...
  oepe:         { system: 'QSRSoft', report: 'Daily Activity (DAR) — drive-thru',  table: 'qsr_daily_activity', formula: 'OEPE = Order-to-Exit (sec) = (dt_untilserve − dt_untilstore) ÷ dt_trans_cnt ÷ 1000, count-weighted. Reconciled exactly to the DAR OEPE column. Manual Ops Report / emailed Glimpse win first; DAR fallback is cloud-fresh (current-day)', grain: 'daily · per store' },
