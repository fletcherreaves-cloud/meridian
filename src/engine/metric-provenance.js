...
export const METRIC_PROVENANCE = {
  ...
  digitalGCRD:  { system: 'QSRSoft', report: 'Digital App (mobileApp report)', table: 'digital_app_monthly', formula: 'Digital App GCs ÷ rest-days. Digital App = Mobile Order Ahead + Scanned Offers (×3) + Loyalty Self-ID Earn + Internal/GMA Delivery', grain: 'monthly · per store' },
  deliveryGCRD: { system: 'QSRSoft', report: 'McDelivery / Delivery (3PO)',    table: 'mcdelivery_monthly',  formula: '3PO GC ÷ rest-days (Combined Vendors: DoorDash/GrubHub/PostMates/UberEats)',             grain: 'monthly · per store' },
  ...
  r2p:          { system: 'QSRSoft', report: 'Daily Activity (DAR)',           table: 'qsr_daily_activity', formula: 'Ready-to-Present, front counter (sec)',                                                  grain: 'daily · per store-hour' },
