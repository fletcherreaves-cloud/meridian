...
export const METRIC_PROVENANCE = {
  ...
  r2p:          { system: 'QSRSoft', report: 'Operations Report (manual)',      table: 'opsRows',            formula: 'R2P = Receipt to Print (sec): tender/receipt-print → KVS bump (order complete). NOTE: manual-upload only today — no same-day cloud source yet (owner sourcing a current-day feed)', grain: 'daily · per store' },
