      ...
      div({ style:S.tblWrap },
        table({ style:S.tbl },
          thead({},
            tr({},
              TH({style:S.th},'Store'),
              h(S2,'salesDay','Best Day'), TH({style:S.thR},'Date'),
              h(S2,'salesWeek','Best Week'), TH({style:S.thR},'Week Of'),
              h(S2,'salesMonth','Best Month'), TH({style:S.thR},'Month'),
              h(S2,'bf','Best Breakfast Day'),
              h(S2,'avgChk','Best Avg Check'),
            ),
          ),
          tbody({},
            ...sorted.map((loc,i) => {
      ...
      div({ style:S.tblWrap },
        table({ style:S.tbl },
          thead({},
            tr({},
              TH({style:S.th},'Store'),
              h(S2,'gcDay','Best GC Day'), TH({style:S.thR},'Date'),
              h(S2,'gcWeek','Best GC Week'), TH({style:S.thR},'Week Of'),
              h(S2,'gcMonth','Best GC Month'), TH({style:S.thR},'Month'),
            ),
          ),
          tbody({},
            ...sorted.map((loc,i) => {
    ...
    div({ style:S.tblWrap },
      table({ style:S.tbl },
        thead({},
          tr({},
            TH({style:S.th},'Store'),
            h(S2,'oepe','Best OEPE'), TH({style:S.thR},'Date'),
            h(S2,'kvs','Best KVS'), TH({style:S.thR},'Date'),
            h(S2,'r2p','Best R2P'), TH({style:S.thR},'Date'),
          ),
        ),
        tbody({},
          ...sorted.map((loc,i) => {
