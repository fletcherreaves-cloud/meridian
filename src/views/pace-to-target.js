...
export function PaceToTargetPanel({ ds, stores, settings, onClose, embedded }) {
  ...
  // embedded = rendered inside the Planning hub: fill the hub body, no full-screen overlay/backdrop
