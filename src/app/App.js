...
const MERIDIAN_CHANGELOG  = [
  {version:'4.939', date:'2026-08-09', changes:[
    'SAGE moved from a full-screen overlay to a drawer that opens from any screen without losing your place — a persistent button lives in the top bar now instead of being buried in the nav list. The minimize-to-a-pill option is still there for anyone who wants it fully out of the way.',
