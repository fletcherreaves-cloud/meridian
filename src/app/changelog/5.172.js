// @ts-nocheck
export default {version:'5.172', date:'2026-08-25', changes:[
  ...
  + 'Fix validated against the LIVE LifeLenz API (not just locally) by dispatching the LifeLenz '
  + 'Daily Sync workflow on this branch before merge and reading the resulting job log.\n\n'
