...
export const PANELS = [
  ...
  { id:'aiscan', label:'Aiscan', icon:'', perm:'analytics.ai', kind:'optional', section:'analytics' },
  ...
  { id:'compare', label:'Compare', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  { id:'corr-explorer', label:'Corr Explorer', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  { id:'dar-daypart', label:'Dar Daypart', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  ...
  { id:'dialedin', label:'DI Calibration', icon:'◎', perm:'analytics.forecasting', kind:'test-kitchen', section:'analytics' },
  { id:'dicompare', label:'DI Compare', icon:'⚡', perm:'analytics.forecasting', kind:'test-kitchen', section:'analytics' },
  ...
  { id:'fcst-accuracy', label:'Forecast Accuracy', icon:'🎯', perm:'analytics.forecasting', kind:'test-kitchen', section:'analytics' },
  { id:'fcst-ref', label:'Fcst Reference', icon:'📐', perm:'analytics.forecasting', kind:'test-kitchen', section:'analytics' },
  ...
  { id:'gm-brief', label:'Gm Brief', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  ...
  { id:'inventory', label:'Inventory', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  { id:'kb', label:'Knowledge Base', icon:'📖', perm:null, kind:'nav', section:'help' },
  { id:'labor-analysis', label:'Labor Analysis', icon:'', perm:'analytics.store', kind:'hub-tab', section:'labor' },
  { id:'labor-analytics', label:'Labor Analytics', icon:'', perm:'analytics.labor', kind:'hub-tab', section:'labor' },
  { id:'leader-one-pager', label:'Leadership One-Pager', icon:'📋', perm:null, kind:'nav', section:'reports' },
  { id:'lfz-gap', label:'LifeLenz Gap', icon:'📊', perm:'analytics.forecasting', kind:'test-kitchen', section:'labor' },
  { id:'lifelenz-bridge', label:'LifeLenz Bridge', icon:'🌉', perm:'analytics.forecasting', kind:'test-kitchen', section:'labor' },
  ...
  { id:'model-assign', label:'Forecast Models', icon:'🎯', perm:'analytics.forecasting', kind:'test-kitchen', section:'analytics' },
  ...
  { id:'perf-calc', label:'Perf Calc', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  ...
  { id:'pmix', label:'Pmix', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  { id:'priorities', label:'Attention Now', icon:'🎯', perm:null, kind:'nav', section:'notifications' },
  { id:'priority-brief', label:'Priority Brief', icon:'', perm:'analytics.brief', kind:'optional', section:'analytics' },
  ...
  { id:'pvsa', label:'Proj vs Actuals', icon:'◑', perm:'analytics.forecasting', kind:'test-kitchen', section:'analytics' },
  { id:'ranking', label:'Rankings', icon:'🏆', perm:'analytics.store', kind:'nav', section:'reports' },
  { id:'record-day', label:'Record Day', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  { id:'report', label:'Date-Range Report', icon:'📅', perm:null, kind:'nav', section:'reports' },
  { id:'revintel', label:'Revintel', icon:'', perm:'analytics.store', kind:'optional', section:'analytics' },
  { id:'sage', label:'SAGE', icon:'🧠', perm:null, kind:'nav', section:'assistant' },
  ...
  { id:'why-engine', label:'Why Engine', icon:'', perm:'analytics.ai', kind:'optional', section:'analytics' },
